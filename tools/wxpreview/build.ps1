...
#   pwsh -File tools/wxpreview/build.ps1 [-Fam 5] [-Day 0] [-T 12345] [-Bg 0]
param([int]$Fam = 5, [int]$Day = 0, [int]$T = 12345, [int]$Bg = 0)
...
& (Join-Path $here "wxpreview.exe") $Fam $Day $T (Join-Path $here "wx.ppm") $Bg
