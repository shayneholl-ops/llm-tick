...
| Thing | Path / value |
|---|---|
| Canonical repo (master @ `f598869` pushed; new work committed 2026-09-19 after final test) | `C:\Users\hxp-n\llm-tick-repo\` |
...
- `4de0fbb` — weather key live; serial `PRESS` line emulates BOOT (hands-free scene testing).
...
- Diagnostic serial commands live in the build (`PRESS / LED 0|1 / BL 0|25|50|100 / PAT 0..6 / ST`) — harmless at runtime (BL 100 = DC, PAT 0 = normal), kept on purpose; 200-Hz-class backlight is a 10-ms-tick 5-substep task (`blTask`), **not** delayMicroseconds (that froze the board) — do not reintroduce spins.
